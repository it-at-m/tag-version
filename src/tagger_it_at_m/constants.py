...
CLI_INVALID_SELECTION_NUMBER = "Invalid selection. Please enter a number between 1 and {}"
...
CLI_NO_VALID_VERSION_TAGS = "⚠️ No valid semantic version tags found. Starting with version 0.0.0"
...
CLI_TAG_LOCALLY_NOT_PUSHED = "The tag was created locally but could not be pushed to remote repository."
CLI_CHECK_PERMISSIONS = "Check your internet connection or repository access permissions."
...
# Core messages
CORE_GIT_TAG_ERROR = "Error: Failed to retrieve git tags. Make sure this is a git repository."
