...
def git_repo():
    ...
    subprocess.run(["git", "config", "user.email", "test@example.com"], check=False, capture_output=True)
    ...
    try:
        ...
        print(f"Warning: Could not fully clean up temp directory due to permissions: {e}")
